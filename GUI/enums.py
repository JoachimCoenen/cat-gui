...
class SizePolicy(DocEnum):
	...
	_ExpandFlag = cast(QSizePolicy.Policy, QSizePolicy.ExpandFlag),            " 2: ExpandFlag:                         The widget should get as much space as possible. (Defined here, only to be able to represent all QSizePolicy values; has no other practical use.)"
	...
	_IgnoreFlag = cast(QSizePolicy.Policy, QSizePolicy.IgnoreFlag),            " 8: IgnoreFlag:                         The widget's size hint is ignored. The widget will get as much space as possible. (Defined here, only to be able to represent all QSizePolicy values; has no other practical use.)"
