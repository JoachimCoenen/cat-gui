# -*- coding: utf-8 -*-
from typing import AbstractSet, Any, Callable, Generic, Hashable, Iterable, Iterator, MutableMapping, Optional, overload, TypeVar, Union
...
class _ItemsView(_ViewBase[_TT], Generic[_TT]):
	# no doc
...
class _KeysView(_ViewBase[_TK], AbstractSet[_TK], Generic[_TK]):
	# no doc
	def __contains__(self, *args, **kwargs): # real signature unknown
		pass
...
class _UniqueKeysView(_ViewBase[_TK], AbstractSet[_TK], Generic[_TK]):
	# no doc
	def __contains__(self, *args, **kwargs): # real signature unknown
		pass
...
class OrderedMultiDict(
	# OrderedMultiDictBase[_TK, _TV],
	MutableMapping[_TK, _TV],
	Generic[_TK, _TV]
):
	...
	def copy(self) -> OrderedMultiDict[_TK, _TV]:
		pass
	...
	def setAll(self, key: _TK, valueList: Iterable[_TV]):
		pass
	...
	def addAll(self, key: _TK, valuelist: Iterable[_TV]):
		"""
	...
	def extend(self, keyValuelist: Iterable[tuple[_TK, _TV]]):
		pass
	...
	@overload
	def popAll(self, key: _TK) -> Union[list[_TV], list[_TT]]:
		"""
	...
	def items(self) -> _ItemsView[tuple[_TK, _TV]]:
		pass
